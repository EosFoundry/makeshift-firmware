...
namespace core
{
    ...
    const uint8_t pinMatrixScan_2 = 22;
    const uint8_t pinMatrixScan_3 = 23;

    const uint8_t pinTouch_IRQ = 7;
    const uint8_t pinTouch_CS = 8;
    const uint8_t pinScreen_DC = 9;
    const uint8_t pinScreen_CS = 10;
    const uint8_t pinTouchScreen_SDI = 11;
    const uint8_t pinTouchScreen_SDO = 12;
    const uint8_t pinTouchScreen_CLK = 13;

    const uint8_t pinEncoder_0_A = 14;
    const uint8_t pinEncoder_0_B = 15;

    const uint8_t pinEncoder_1_A = 16;
    const uint8_t pinEncoder_1_B = 17;

    const uint8_t pinEncoder_2_A = 24;
    const uint8_t pinEncoder_2_B = 25;

    const uint8_t pinEncoder_3_A = 26;
    const uint8_t pinEncoder_3_B = 27;
